...
export function Alert({title, message, type = "info", duration = 3000, onClose}) {
    ...
    return (
        <div
            className={`border-l-4 p-4 absolute w-3/4 z-10 rounded-md shadow-md flex items-center transition-all duration-500 transform ${fade} ${alertStyles[type]}`}
            role="alert"
        >
            {alertIcons[type]}
            <div>
